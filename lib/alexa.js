...
function ResponseBuilder(self) {
    ...
    return (function () {
        return {
            ...
            'videoPlayer': function(source, title, subtitle) {
                var videoPlayerDirective = {
                ...
                if(title || substitle) {
                    videoPlayerDirective['metadata'] = {};
					
                    if(title) {
                        videoPlayerDirective.metadata['title'] = title;
                    }
					
                    if(subtitle) {
                        videoPlayerDirective.metadata['substitle'] = subtitle;
                    }
                }
