...
function alexaRequestHandler(event, context, callback) {
    ...
    Object.defineProperty(handler, 'audioData', {
        value: {},
        writable: true
    });
...
function initializeAudioAttributes() {
    ...
    this.attributes[':heard'] = Array.apply(null, {length: this.audioData.length}).map(function () { return false; });
}
...
module.exports.InitializeAudioAttributes = initializeAudioAttributes;
