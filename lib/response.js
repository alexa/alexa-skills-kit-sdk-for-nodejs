...
module.exports = (function () {
    return {
        ...
        ':audioPlayerPlay':function(speechOutput, playBehavior, streamUrl, streamToken, streamOffsetInMiliseconds){
          // Note the streamUrl should be a valid HTTPS endpoint
          this.handler.response = buildSpeechletResponse({
              ...
              directives: [
                    {
                      ...
                      audioItem: {
                        stream: {
                          token: streamToken,
                          url: streamUrl,
                          offsetInMilliseconds: streamOffsetInMiliseconds
                        }
                      }
                    }
              ],
