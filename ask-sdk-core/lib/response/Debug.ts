...
export class Debug {
     ...
     */
    startWithCustomDelay(customTimeDelay : number) {
    ...
    speak(param : any) {
        ...
        var paramIsPrimitive = ( paramType === 'number'
     ...
     * @param {*} Whatever you want to speak, any valid Javascript type.
     */
    forceSpeak(handlerInput : any, param : any) {
        this.textToBeRead = "";
        this.speak(param);
    ...
    private timeDelay() {
        ...
        var breakTag = '<break time=\"' + String(this.timeBetweenEachDebugStatement) + 's\"/> ';
        return breakTag;
    }
     ...
     */
    setTimeDelay(desiredBreakTime : number) {
